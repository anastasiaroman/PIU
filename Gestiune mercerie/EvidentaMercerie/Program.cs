...
namespace GestiuneMercerie
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Produse produs1 = CitireProdusTastatura();
            int cantitate1 = CitireCantitateTastatura();

            Produse produs2 = CitireProdusTastatura();
        ...
        public static Produse CitireProdusTastatura()
        {
            ...
            return new Produse(0, nume, categorie, pret);
        }
